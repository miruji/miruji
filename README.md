...
- [chillffi](https://github.com/rts-lang/chillffi) — a Rust framework for FFI isolation. Allows isolating unsafe FFI from the runtime; uses the zygote principle, similar to approaches used by Firefox and Android.
